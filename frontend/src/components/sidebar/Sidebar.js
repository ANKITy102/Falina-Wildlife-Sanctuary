  ...
  return (
    <div className="h-full w-1/6 bg-sky-800 pb-14 flex flex-col justify-between">
        ...
        <div className=" text-white flex flex-col justify-center items-center">
            <div><img src={avatar} alt="avatar" width="55px"/></div>
            <div className="text-[17px]">Dev Rathore</div>
            <div className="text-sm text-slate-400">devrathore293@gmail.com</div>
        </div>
    </div>
  )
}
